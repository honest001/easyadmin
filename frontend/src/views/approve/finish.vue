  ...
  <div class="approve-finish">
    ...
    >
      <el-form :model="currentApprove" label-width="100px">
        ...
        <el-form-item label="审批状态">
          <el-tag v-if="currentApprove.approveStatus === 1" type="success">已通过</el-tag>
        ...
        <el-form-item label="审批时间">
          <span>{{ currentApprove.approveTime }}</span>
        </el-form-item>
...
import { getFinishApproveList } from '../../api/approve'
...
const loadApproveList = async () => {
  try {
    const response = await getFinishApproveList({
      ...searchForm.value,
